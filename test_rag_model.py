...
st.title("🧪 RAG Model Simple Test")
st.write("ไฟล์นี้ใช้ทดสอบเฉพาะการตั้งค่า API และฟังก์ชัน RAG เท่านั้น")
...
**สำคัญ:** ตอบกลับเป็น JSON array เท่านั้น ไม่ต้องมีข้อความอื่น
"""
